...
public class CacheKey
{
    ...
    public const string UsersCache = "UsersCache";
}
...
/// <summary>
/// <para>Code: ma nhan vien.</para>
/// <para>This class is used to store the key of the context items.</para>
/// </summary>
public static class ContextItemsKey
{
