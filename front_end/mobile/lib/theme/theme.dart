...
class AppTheme {
  static const Color primaryColor = Color(0xFF065471);
  static const Color primaryLight = Color(0xFF818CF8);
  static const Color primaryDark = Color(0xFF3730A3);

  static const Color secondaryColor = Color(0xFF0A91AB);
  ...
  static const Color sufaceColor = Color(0xFFF8FAFC);
  static const Color textPrimary = Color(0xFFFFC045);
